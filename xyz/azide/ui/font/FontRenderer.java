package xyz.azide.ui.font;

import net.minecraft.client.renderer.GlStateManager;
import net.minecraft.client.renderer.texture.DynamicTexture;
import net.minecraft.util.ResourceLocation;
import org.lwjgl.opengl.GL11;
import xyz.azide.util.render.FontUtil;
...
/**
 * Forked from:
 * https://github.com/Godwhitelight/FontRenderer/blob/main/FontRenderer.java"
 */
...
public class FontRenderer extends CFont {
    ...
    public FontRenderer(String name, int size, int type, boolean antiAlias, boolean fractionalMetrics) {
        super(FontUtil.getFontFromTTF(new ResourceLocation("azide/font/" + name + ".ttf"), size, type), antiAlias, fractionalMetrics);
        setupMinecraftColorcodes();
        setupBoldItalicIDs();
    }
