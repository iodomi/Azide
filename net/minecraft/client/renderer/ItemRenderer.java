...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
            ...
            final float swingProgressSine = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float) Math.PI);
            ...
            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof ItemMap) {
                    ...
                    final Animations animations = (Animations) Azide.getSingleton().getModuleManager().getModule(Animations.class);
                    ...
                    switch (enumaction) {
                        ...
                        case BLOCK:
                            if (animations.isEnabled()) {
                                switch (animations.animationType.getFormattedValue()) {
                                    case "Old":
                                        this.transformFirstPersonItem(0.2f, swingProgress);
                                        this.blockTransformations();
                                        GlStateManager.translate(-0.5f, 0.2f, 0.0f);
                                        break;
                                    case "Azide":
                                        this.transformFirstPersonItem(0.2f, swingProgress);
                                    ...
                                    case "Swing":
                                        ...
                                        GlStateManager.translate(-0.35f, 0.1f, 0.0f);
                                        GlStateManager.translate(-0.05f, -0.1f, 0.1f);
                                        this.blockTransformations();
                                        break;
                                    case "Exhibition":
                                        this.transformFirstPersonItem(equipProgress / 2.0f, 0.0f);
                                        GlStateManager.translate(0.0f, 0.3f, -0.0f);
                                        GlStateManager.rotate(-swingProgressSine * 31.0f, 1.0f, 0.0f, 2.0f);
                                        GlStateManager.rotate(-swingProgressSine * 33.0f, 1.5f, (swingProgressSine / 1.1f), 0.0f);
                                        this.blockTransformations();
                                        break;
                                }
